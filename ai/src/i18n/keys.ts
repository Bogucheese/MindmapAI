...
export const EN_STRINGS: Record<string, string> = {
  ...
  aiAgentNoSubmit: 'The agent did not submit chart slots.',
  aiAgentSlotsInvalid: 'Submitted slots failed validation.',
  aiChartTooSmall: 'Chart content is too thin.',
  aiSummarize: 'Summarize & suggestions…',
  aiStageSummarize: 'Summarizing the map...',
  aiSourceFile: 'File (Markdown/Word/PDF)',
  aiSourceFileField: 'Document',
  aiFileChoose: 'Choose file…',
  aiFileNone: '(no file chosen)',
  aiFileRequired: 'Please choose a document file.',
  aiFileReading: 'Reading document...',
  aiFileReadFail: 'Failed to read the document',
  aiFileTooLarge: 'file too large (over 20MB)',
  aiFileUnsupported: 'unsupported format (use .md / .txt / .docx / .pdf)',
  aiFileCorrupt: 'cannot read the document (file corrupted or format mismatch)',
  aiFileEmpty: 'no readable text extracted; try pasting the text instead',
  aiPdfThin: 'too little text extracted (scanned/encrypted/complex-encoding PDF); try pasting the text instead',
  ...
  aiFetchHint: 'GitHub links are fetched directly; other sites fall back to the built-in local relay (start.sh/start.cmd), then the configured fetch proxy.',
  aiLinkInvalid: 'Please enter a valid http(s) link.',
  aiFetchingPage: 'Fetching page...',
  aiFetchFailed: 'Failed to fetch the page',
  aiFetchBrowserHint: 'direct fetch, built-in relay and proxy all failed; check the link or network, or set a custom fetch proxy in AI settings.',
  aiFetchThinProxyFail: 'direct fetch too thin and proxy failed',
  aiSourceTitle: 'Title',
  ...
  aiLangZh: 'Chinese',
  aiChartMaxItems: 'Max items per chart',
  aiChartMaxItemsHint: '0 = auto',
  aiChartName_circle: 'Circle Map',
  aiChartName_bubble: 'Bubble Map',
  aiChartName_doubleBubble: 'Double Bubble Map',
  aiChartName_tree: 'Tree Map',
  aiChartName_flow: 'Flowchart',
  aiChartName_multiFlow: 'Multi-Flow Map',
  aiChartName_brace: 'Brace Map',
  aiChartName_venn: 'Venn Diagram',
  aiChartName_fishbone: 'Fishbone',
  aiChartName_timeline: 'Timeline',
  aiChartName_bridge: 'Bridge Map',
  aiChartName_org: 'Org Chart',
  aiChartDesc_circle: 'Defines a topic with a central circle surrounded by related ideas. Great for brainstorming and free association.',
  aiChartDesc_bubble: 'A central bubble with surrounding attribute bubbles; analyzes and describes the properties of a topic.',
  aiChartDesc_doubleBubble: 'Compares two things: shared traits in the middle, unique traits on each side.',
  aiChartDesc_tree: 'Groups and classifies knowledge like a tree: a trunk topic with branching categories and members.',
  aiChartDesc_flow: 'Shows sequence and process with semantic shapes (steps, decisions, inputs/outputs); supports swimlanes, branches and loops.',
  aiChartDesc_multiFlow: 'Cause-effect thinking: the event in the center, causes on the left, effects on the right.',
  aiChartDesc_brace: 'Uses a brace to show whole-part relationships and the component structure of a thing.',
  aiChartDesc_venn: 'Overlapping circles showing commonalities and differences between sets.',
  aiChartDesc_fishbone: 'Cause-effect diagram drilling to root causes: categories as big bones, specific causes as small bones.',
  aiChartDesc_timeline: 'Orders events chronologically along an axis to show development and progress.',
  aiChartDesc_bridge: 'Analogy pairs above and below a bridge line, reusing the same relation across groups.',
  aiChartDesc_org: 'Shows hierarchy: people, roles and departments in an organization or category tree.',
};
